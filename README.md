...
- 📊 **Real-time Voronoi Diagrams** - Visualize spatial control on the pitch
...
- 📈 **Interactive Dashboard** - Explore multiple shot events with ease
- 🎨 **Beautiful Visualizations** - Professional pitch graphics with Plotly
